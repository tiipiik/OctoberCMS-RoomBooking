...
+function ($) { "use strict";
    var PostForm = function () {
        this.$preview = $('#room-post-preview')
        ...
        this.$textarea = $('[name="Room[content]"]', this.$form)
        this.$previewContent = $('.preview-content', this.$preview)
        this.codeEditor = $('textarea[name="Room[content]"]', this.$form).closest('.field-codeeditor').data('oc.codeEditor')
    ...
    PostForm.prototype.createIndicator = function() {
        var $previewContainer = $('#room-post-preview').closest('.loading-indicator-container')
    ...
    PostForm.prototype.initDropzones = function() {
        ...
        $(document).on('click', '#room-post-preview span.dropzone', function() {
            $('input[type=file].trigger', $(this).parent()).click()
        })

        $(document).on('change', '#room-post-preview input[type=file].trigger', function(e) {
